...
const IRIS = new THREE.Color("#56a69d");
const IRIS_BRIGHT = new THREE.Color("#8fd1c6");
const IRIS_DEEP = new THREE.Color("#2f6b66");
const AMBER = new THREE.Color("#c58b58");
const AMBER_BRIGHT = new THREE.Color("#e0ae73");
...
const EDGE_SYS = new THREE.Color("#2f6b66");
const EDGE_WORK = new THREE.Color("#2f6b66");
...
function glowTexture(): THREE.Texture {
  ...
  g.addColorStop(0, "rgba(143,209,198,0.95)");
  g.addColorStop(0.4, "rgba(86,166,157,0.30)");
  g.addColorStop(1, "rgba(86,166,157,0)");
  ctx.fillStyle = g;
