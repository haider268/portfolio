...
const IRIS = new THREE.Color("#7189b8");
const IRIS_BRIGHT = new THREE.Color("#a6b9e0");
const IRIS_DEEP = new THREE.Color("#394b70");
const AMBER = new THREE.Color("#d2ad72");
const AMBER_BRIGHT = new THREE.Color("#e7cb94");
...
const EDGE_SYS = new THREE.Color("#394b70");
const EDGE_WORK = new THREE.Color("#394b70");
...
function glowTexture(): THREE.Texture {
  ...
  g.addColorStop(0, "rgba(166,185,224,0.95)");
  g.addColorStop(0.4, "rgba(113,137,184,0.30)");
  g.addColorStop(1, "rgba(113,137,184,0)");
  ctx.fillStyle = g;
